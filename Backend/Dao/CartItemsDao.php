...
class CartItemsDao extends BaseDao
{
    ...
    {
        $sql = "SELECT * FROM cart_items ci JOIN carts c ON ci.cart_id = c.cart_ID WHERE cart_item_id = :cart_item_ID AND user_id = :user_ID";
        ...
        $sql = 'DELETE FROM cart_items ci WHERE cart_item_ID = :cart_item_ID';
