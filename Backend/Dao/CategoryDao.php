...
class CategoryDao extends BaseDao
{
    ...
    {
        $sql = "select c.category_id,c.name AS category_name ,s.subcategory_id, s.name as subcategory_name from categories c JOIN subcategories s on c.category_id = s.category_id";
